        ...
        <div className="min-h-screen bg-gradient-to-br from-sky-50 via-white to-amber-50 p-4 md:p-8">
            ...
            <div className="max-w-3xl mx-auto relative">
                ...
                <div className="mb-10 text-center">
                    <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-r from-pink-400 to-cyan-300 mb-4 shadow-lg">
                        <FaGlobeAmericas className="text-white text-2xl" />
                    </div>
                    <h1 className="text-4xl font-bold bg-gradient-to-r from-pink-600 to-amber-500 bg-clip-text text-transparent mb-2">
                ...
                <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl overflow-hidden border border-gray-100">
                    ...
                    <div className="p-6 border-b border-gray-100 bg-gradient-to-r from-pink-50 to-amber-50">
                        <div className="flex items-center justify-between">
                            <Link
                                to="/profile"
                                className="group flex items-center text-pink-600 hover:text-pink-800 transition-all duration-300 font-medium"
                            >
                                <div className="flex items-center justify-center w-10 h-10 rounded-full bg-white group-hover:bg-pink-50 border border-pink-100 mr-3 transition-all group-hover:scale-105">
                                    <FaTimesCircle className="text-pink-400 group-hover:text-pink-600 transition-colors" />
                                </div>
                            ...
                            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                                ...
                                <div className="space-y-6">
                                    <div className="flex items-center space-x-3 mb-6">
                                        <div className="flex items-center justify-center w-12 h-12 rounded-full bg-gradient-to-r from-pink-100 to-cyan-50">
                                            ...
                                            render={({ field }) => (
                                                <FormItem>
                                                    <FormLabel className="flex items-center space-x-2 text-gray-700">
                                                        <FaPassport className="text-pink-400" />
                                                        <span>Full Name</span>
                                                    </FormLabel>
                                                    <FormControl>
                                                        <div className="relative group">
                                                            <Input
                                                                ...
                                                                className="pl-12 pr-4 py-6 border-2 border-gray-200 hover:border-pink-300 focus:border-pink-400 transition-all rounded-xl bg-gray-50 group-hover:bg-white focus:bg-white focus:ring-4 focus:ring-pink-100"
                                                                {...field}
                                                            />
                                                            <div className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-400 group-hover:text-pink-400 transition-colors">
                                                                <FaUser />
                                                            </div>
                                                        </div>
                                                    </FormControl>
                                ...
                                <div className="pt-8 flex flex-col sm:flex-row justify-end space-y-4 sm:space-y-0 sm:space-x-4">
                                    ...
                                    <button
                                        type="submit"
                                        className="px-8 py-4 rounded-xl bg-gradient-to-r from-pink-500 to-cyan-400 text-white font-medium shadow-lg hover:shadow-xl hover:from-pink-600 hover:to-cyan-500 transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98]"
                                    >
                                        Update Travel Profile
                                    </button>
                                </div>
                    ...
                    <div className="px-10 py-6 bg-gradient-to-r from-gray-50 to-gray-100 border-t border-gray-200">
                        <div className="flex items-center justify-between text-sm text-gray-500">
                            ...
                            <div className="flex items-center space-x-1">
                                <FaGlobeAmericas className="text-pink-400" />
                ...
                <div className="mt-8 text-center">
                    <p className="text-gray-500 text-sm">
                        <span className="font-medium text-pink-500">Pro Tip:</span> Keep your profile updated for personalized travel recommendations and smoother check-ins worldwide.
                    </p>
                </div>
            </div>
        </div>
